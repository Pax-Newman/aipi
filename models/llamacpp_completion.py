...
class LlamaCPPCompletionModelConfig(ModelConfig):
    type: str
    context_length: int
    gpu_layers: int

class LlamaCPPCompletionModel(TextCompletionModelInterface):
    def __init__(self, **kwargs):
        self.config = LlamaCPPCompletionModelConfig.model_validate(kwargs)
